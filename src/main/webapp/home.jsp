...
<body>
	<div class="row">
		<div id="column1">
			...
			</select> <input style="display: inline" type="text" name="course"
				placeholder="Course Name"> <input style="display: inline"
				type="submit" id="request_courses">
			<div class="dropdown">
				<button type='button' id="open_schedule"
					class="dropbtn popup_schedule">Current Classes</button>
			...
			<p>
				...
				<a href="https://kognise.github.io/water.css/">water.css</a>, <a
					href="http://tristen.ca/tablesort/demo/">tablesort</a>, and <a
					href="https://fullcalendar.io/">FullCalendar</a>. <a id="myBtn">Feedback?</a>
			</p>
